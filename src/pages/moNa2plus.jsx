        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          <div className="relative group">
            ...
            <div className="relative aspect-[4/3] bg-white rounded-[2.5rem] overflow-hidden shadow-xl ring-1 ring-slate-900/5">
              <img 
                src="https://images.unsplash.com/photo-1587829745563-844184a3d17e?auto=format&fit=crop&q=80&w=800" 
                alt="moNa 2+" 
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex gap-2">
                <span className="text-xs font-bold text-slate-400 border border-slate-200 px-2 py-0.5 rounded-md">Wireless</span>
                <span className="text-xs font-bold text-slate-400 border border-slate-200 px-2 py-0.5 rounded-md">Brass Weight</span>
              </div>
            </div>
            ...
            <p className="text-lg text-slate-600 leading-loose mb-10 font-medium">
              真鍮ウェイトがもたらす静寂と安定感。ケーブルから解き放たれた、究極のタイピング体験を提供するフラッグシップ。
            </p>
            ...
            <div className="flex items-center gap-6 p-6 bg-white rounded-3xl border-2 border-slate-100 shadow-sm">
              <div className="flex-1">
                ...
                <p className="text-3xl font-black text-slate-800 font-mono">¥34,500<span className="text-sm text-slate-500 font-normal">~</span></p>
              </div>
        ...
        <div className="mb-24">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-3">完全ワイヤレス体験</h3>
              <p className="text-slate-600 leading-relaxed font-medium">
                最新のBluetooth規格に対応。デスクからケーブルを排除し、極めてクリーンで洗練されたワークスペースを実現します。
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-3">ソリッドブラスウェイト</h3>
              <p className="text-slate-600 leading-relaxed font-medium">
                底面に専用設計の真鍮（ブラス）ウェイトを搭載。打鍵時の振動を物理的に抑え込み、プレミアムな打鍵感をもたらします。
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
            <dl className="divide-y divide-slate-100">
              {[
                ...
                { label: 'Connection', value: 'Bluetooth 5.0 (BLE) / USB Type-C' },
                { label: 'Firmware', value: 'ZMK Firmware対応' },
                { label: 'Weight', value: '約 1.2kg (完成時・ブラスウェイト含む)' },
              ].map((spec, i) => (
