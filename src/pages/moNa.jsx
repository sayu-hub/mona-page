        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          <div className="relative group">
            ...
            <div className="relative aspect-[4/3] bg-white rounded-[2.5rem] overflow-hidden shadow-xl ring-1 ring-slate-900/5">
              <img 
                src="https://images.unsplash.com/photo-1595225476474-87563907a212?auto=format&fit=crop&q=80&w=800" 
                alt="moNa" 
          ...
          <div>
            ...
            <div className="flex items-center gap-6 p-6 bg-white rounded-3xl border-2 border-slate-100 shadow-sm">
              <div className="flex-1">
                ...
                <p className="text-3xl font-black text-slate-800 font-mono">¥24,800<span className="text-sm text-slate-500 font-normal">~</span></p>
              </div>
        ...
        <div className="mb-24">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-3">計算し尽くされた打鍵感</h3>
              <p className="text-slate-600 leading-relaxed font-medium">
                内部の空洞を極限まで減らし、打鍵時の反響音を抑える設計。指先に心地よいフィードバックだけを残します。
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-3">堅牢なアクリル積層ボディ</h3>
              <p className="text-slate-600 leading-relaxed font-medium">
                マット加工を施した厚みのあるアクリルを幾重にも重ねることで、見た目の美しさと確かな重量感を両立しました。
              </p>
            </div>
          </div>
        </div>
